  ...
  return (
    <div className="h-16 bg-custom-gradient  z-50 flex items-center sticky top-0 ">
      <div className="lg:px-14 sm:px-8 px-4 w-full flex justify-between">
        <Link to="/">
          <h1 className="inline font-bold text-3xl text-white italic sm:mt-0 mt-2 mr-3">
            Shortify 
          </h1>
          <h1 className=" inline font-bold text-1xl text-white italic sm:mt-0 mt-2">
                -by Kushagra Mishra
          </h1>
        ...
        >
          ...
          {!token && (
            <Link to="/register">
              <li className=" sm:ml-0 -ml-1 bg-blue-900 text-white  cursor-pointer w-20 text-center font-semibold px-2 py-2 rounded-md  hover:text-blue-900 hover:bg-gray-200  transition-all duration-400">
                Sign Up
              </li>
            </Link>
            )}
